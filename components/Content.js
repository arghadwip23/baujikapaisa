...
const handleClick = async()=>{
  ...
  return (
    <div className='h-2/3 w-2/3 text-center p-4 bg-black rounded'>
        ...
        <h5 className='text-gray-500'>earn money with us</h5>
        ...
        <div className='text-left mx-20 my-1'>
            ...
            <button type="button" className="py-2.5 px-5 mx-20 my-10 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" onClick={handleClick}>Alternative</button>
        </div>
         </div>
  )
}
